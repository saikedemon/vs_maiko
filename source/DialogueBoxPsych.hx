...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	function addCharacter(char:FlxSprite, name:String) {
		switch(name) {
			...
			case 'maiko':
				char.frames = Paths.getSparrowAtlas('dialogue/Maiko_Dialogue');
				char.animation.addByPrefix('talkIdle', 'maiko_idle', 24, true);
				char.animation.addByPrefix('talk', 'maiko_talk', 24, true);
				char.animation.addByPrefix('smugIdle', 'smug_idle', 24, true);
				char.animation.addByPrefix('smug', 'smug_talk', 24, true);
				char.x += 200;
				char.y -= 140;

			case 'crowd':
				char.frames = Paths.getSparrowAtlas('dialogue/crowd');
				char.animation.addByPrefix('talkIdle', 'crowd', 24, true);
				char.animation.addByPrefix('talk', 'crowd', 24, true);
				char.y += 70;
		}
