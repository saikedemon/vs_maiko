...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var assText:String = "Song by dark_entity CM!";
		guestText = new FlxText(800, 69, 0, assText, 32);
		guestText.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.WHITE, RIGHT);

		guestBG = new FlxSprite(guestText.x - 6, 66).makeGraphic(600, 66, 0xFF000000);
		guestBG.alpha = 0.6;
	...
	override function update(elapsed:Float)
	{
		...
		if (songs[curSelected].songName == 'Magician')
		{			
			add(guestText);
			add(guestBG);
			guestText.y = 69;
